...
class User extends ActiveRecord implements IdentityInterface
{
   ...
   public $password_repeat;
     ...
     */
     public function getAdress():?UserAddress
     {
         
        
        $adreess=$this->addresses[0]?? new UserAddress() ;
        $adreess->user_id=$this->id;
        return $adreess;
    ...
    {
        return [
            self::STATUS_ACCESS => 'Access',
            self::STATUS_NOACCESS => 'UnAccess',
